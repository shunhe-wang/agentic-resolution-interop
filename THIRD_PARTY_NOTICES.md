...
This repository depends on the following packages at the versions locked in `package-lock.json`.
...
Dependency license texts remain available in installed package distributions and their source repositories.

The entries above are informational and do not modify the applicable license terms.
